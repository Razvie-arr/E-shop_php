...
class ProductEditForm extends Form {
    ...
    private function createSubcomponents(): void {
        ...
        $this->addText('stock', 'Množství dostupného produktu skladem')
            ->setHtmlType('number')
            ->addRule(Form::NUMERIC, 'Musíte zadat číslo.')
            ->setRequired('Musíte zadat množství produktu');
        ...
        $this->addSubmit('ok', 'uložit')
            ...
            $product->assign($values, ['title', 'url', 'description', 'recommend']);
            $product->price = floatval($values['price']);
            $product->stock = intval($values['stock']);
