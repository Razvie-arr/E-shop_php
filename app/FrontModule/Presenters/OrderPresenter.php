...
class OrderPresenter extends BasePresenter {
    ...
    protected function createComponentOrderForm(): OrderForm {
        ...
        $form->onFinished[] = function ($message = '') use ($form) {
            ...
            $mail->htmlBody = '<p>Děkujeme za vaši objednávku v našem eshopu.</p> <p>Na vaší objednávce začínáme okamžitě pracovat. Během pár okamžiků vám pošleme fakturu, tu prosím bezprostředně uhraďte.</p> <p>Po uhrazení faktury bude vaše objednávka ihned odeslána. Pokud nebude faktura zaplacena do 48 hodin, tak bude vaše objednávka zrušena.</p>';
